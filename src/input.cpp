...
template<typename T>
void fileReader::getVectorValue(string optName, arrayt<T> &opt)
{
  string str, optKey;
...
template<typename T>
void fileReader::getVectorValueOptional(string optName, arrayt<T> &opt)
{
  string str, optKey;
  ...
  // Option was not found; setup arrayt to size 0
  opt.setup(0);
}
