...
/*void eles_hexas::set_shape(arrayt<int> &in_n_spts_per_ele)
{
...
void eles_hexas::set_loc_1d_spts(arrayt<double> &loc_1d_spts, int in_n_1d_spts)
{
  int i;
...
double eles_hexas::compute_inter_detjac_inters_cubpts(int in_inter,arrayt<double> d_pos)
{
  double output = 0.;
  double xr, xs, xt;
  double yr, ys, yt;
...
double eles_hexas::eval_nodal_basis(int in_index, arrayt<double> in_loc)
{
  int i,j,k;
...
//
double eles_hexas::eval_nodal_basis_restart(int in_index, arrayt<double> in_loc)
{
  int i,j,k;
...
double eles_hexas::eval_d_nodal_basis(int in_index, int in_cpnt, arrayt<double> in_loc)
{
  int i,j,k;
...
double eles_hexas::eval_nodal_s_basis(int in_index, arrayt<double> in_loc, int in_n_spts)
{
  int i,j,k;
...
void eles_hexas::eval_d_nodal_s_basis(arrayt<double> &d_nodal_s_basis, arrayt<double> in_loc, int in_n_spts)
{
  int i,j,k;
...
void eles_hexas::fill_opp_3(arrayt<double>& opp_3)
{
  int i,j,k;
...
double eles_hexas::eval_div_vcjh_basis(int in_index, arrayt<double>& loc)
{
  int i,j,k;
  double eta;
