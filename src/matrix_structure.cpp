...
void CSysMatrix::Initialize(int n_verts, int n_verts_global, int n_var, int n_eqns, arrayt<arrayt<int> > &v2e, arrayt<int> &v2n_e, arrayt<int> &e2v) {
...
void CSysMatrix::AddBlock(unsigned long block_i, unsigned long block_j, arrayt<double> val_block) {
	unsigned long iVar, jVar, index, step = 0;
