...
void inters::right_flux(arrayt<double> &f_r, arrayt<double> &norm, arrayt<double> &fn, int n_dims, int n_fields, double gamma)
{
...
// Rusanov inviscid numerical flux
void inters::rusanov_flux(arrayt<double> &u_l, arrayt<double> &u_r, arrayt<double> &v_g, arrayt<double> &f_l, arrayt<double> &f_r, arrayt<double> &norm, arrayt<double> &fn, int n_dims, int n_fields, double gamma)
{
  double vx_l,vy_l,vx_r,vy_r,vz_l,vz_r,vn_l,vn_r,p_l,p_r,vn_g,vn_av_mag,c_av,eig;
  arrayt<double> fn_l(n_fields),fn_r(n_fields);
...
void inters::convective_flux_boundary( arrayt<double> &f_l, arrayt<double> &f_r, arrayt<double> &norm, arrayt<double> &fn, int n_dims, int n_fields)
{
  arrayt<double> fn_l(n_fields),fn_r(n_fields);
...
void inters::roe_flux(arrayt<double> &u_l, arrayt<double> &u_r, arrayt<double> &v_g, arrayt<double> &norm, arrayt<double> &fn, int n_dims, int n_fields, double gamma)
{
  double p_l,p_r;
  double h_l, h_r;
...
// Rusanov inviscid numerical flux
void inters::lax_friedrich(arrayt<double> &u_l, arrayt<double> &u_r, arrayt<double> &norm, arrayt<double> &fn, int n_dims, int n_fields, double lambda, arrayt<double>& wave_speed)
{
...
void inters::ldg_flux(int flux_spec, arrayt<double> &u_l, arrayt<double> &u_r, arrayt<double> &f_l, arrayt<double> &f_r, arrayt<double> &norm, arrayt<double> &fn, int n_dims, int n_fields, double tau, double pen_fact)
{
  arrayt<double> f_c(n_fields,n_dims);
...
// LDG common solution
void inters::ldg_solution(int flux_spec, arrayt<double> &u_l, arrayt<double> &u_r, arrayt<double> &u_c, double pen_fact, arrayt<double>& norm)
{
