...
protected:
  ...
  arrayt<double> loc_upts_pri_tri;
  arrayt<double> loc_upts_pri_1d;
  arrayt<double> loc_1d_fpts;

  arrayt<double> loc_upts_pri_tri_rest;
  arrayt<double> loc_upts_pri_1d_rest;

  arrayt<double> vandermonde_tri;
  arrayt<double> inv_vandermonde_tri;
  arrayt<double> inv_vandermonde_tri_rest;
