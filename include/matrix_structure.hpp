...
private:
	...
	double *block;             /*!< \brief Internal arrayt to store a subblock of the matrix. */
	double *prod_block_vector; /*!< \brief Internal arrayt to store the product of a subblock with a vector. */
	double *prod_row_vector;   /*!< \brief Internal arrayt to store the product of a matrix-by-blocks "row" with a vector. */
	double *aux_vector;		   /*!< \brief Auxilar arrayt to store intermediate results. */
...
public:
	 ...
	 */
    void Initialize(int n_verts, int n_verts_global, int n_var, int n_eqns, arrayt<arrayt<int> > &v2e, arrayt<int> &v2n_e, arrayt<int> &e2v);
  ...
  /*!
	...
	void AddBlock(unsigned long block_i, unsigned long block_j, arrayt<double> val_block);
